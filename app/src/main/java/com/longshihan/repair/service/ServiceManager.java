package com.longshihan.repair.service;

import android.content.Context;
import android.support.constraint.solver.Cache;

import com.longshihan.repair.utils.Constants;
    ...
    public static <T> T createService(Context context, Class<T> t) {
        ...
        if (service == null) {
            ...
            if (baseDir != null) {
                ...
                clientBuilder.cache(new okhttp3.Cache(cacheDir, Constants.HTTP_RESPONSE_DISK_CACHE_MAX_SIZE));
            }
